...
b1=xlwt.Workbook()
sheetthird=b1.add_sheet("p300sec")
'''
...
for a in range(0,54):
    for b in range(0,54):
        ...
        for x in range(4, 16):
            ...
            for y in range(1, st1.nrows):
                ...
                if hr > 7 and hr <= 17:
                    ...
                    ''''
                    splitting the data into time intervals and for every 10sec the loop is repeating and taking the values in the form of 5min
                    '''
        ...
        avg = []
        '''every value is being checked in the 300sec interval range and that values are being doctects / dur val calculated'''
